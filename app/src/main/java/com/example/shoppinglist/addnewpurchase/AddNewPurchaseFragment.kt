...
class AddNewPurchaseFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding.ok.setOnClickListener {
            ...
            if ( text != "") {
                viewModel.onInsertPurchase((binding.spinnerName.selectedItem as PurchaseName).id, text.toDouble(), (binding.spinnerMeasureUnit.selectedItem as MeasuringUnit).id)
